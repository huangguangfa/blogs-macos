<template>
  <div class="controlcenter">
    <div
      class="controlcenter-img"
      :class="{ selectControlcenter: isShowControlcenter }"
    >
      <img
        src="@/assets/images/topbar/controlcenter.png"
        alt=""
        @click="handleShowControlcenter(true)"
        v-clickoutside="handleShowControlcenter"
      />
        ...
        <div class="controlcenter-content-options">
          <div class="options-content">
            <div class="options-left bg-radius-com">
              <div
                class="options-row"
                v-for="(item, index) in options.module"
                :key="index"
              >
                <div
                  class="options-wifi options-coms"
                  :class="{ off: item.is_start === false }"
                >
            ...
            <div class="options-right">
              ...
              <div class="right-mode-bottom">
                ...
                <div
                  @click="handleFullScreens"
                  class="right-mode-bottom-item bg-radius-com"
                  :class="{ select: isFullscreen }"
                >
    ...
    <RightSidebar
      :style="`transform: translateX(${state.showSidebar ? 0 : '100%'})`"
    ></RightSidebar>
  </div>
</template>
...
let isShowControlcenter = computed(
  () => systemStore.SYSTEM_CONFIG.isShowControlcenter
);
//销毁
onUnmounted(() => {
