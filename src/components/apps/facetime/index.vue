        ...
        <window v-model:show="show" title="Facetime" width="1000" height="600">
            <div class="facetime-content" v-if="show">
                <div class="active-user">
                    <div class="user" v-for="item in 10" :key="item">
                        <div class="flex align-items-center">
                            ...
                            <div class="user_info">
                                <p class="user-phone">18720706348</p>
                                <p class="user-name">王武</p>
                            </div>
                        </div>
                       
                        <i class="iconfont macos-shipindianhua"></i>
                    </div>
                </div>
                <div id="videos">
                    <video class="otherSide" ref="videos" autoplay></video>
                    <video class="local-video" ref="videoss" autoplay></video>
                </div>
                <!--  -->
            ...
            watch( () => props.show ,(status) => {
                ...
                if( status ){
                    getUserMedia( stream => {
                        ...
                        videoss.value.srcObject = stream;
...
.facetime-content{
    ...
    display: flex;
    .active-user{ width: 240px;height: 100%;padding:20px; overflow: hidden; box-sizing: border-box; overflow-y: auto;
        .user{display: flex;align-items: center; justify-content: space-between; position: relative;padding-bottom:10px;margin-top:10px;
            &::after{
                content: "";position: absolute;bottom: 0;left: 45px;
                width: 100%;height: 1px;background: rgba(204,204,204,1);
            }
