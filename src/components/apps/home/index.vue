<template>
  <div class="home">
    ...
    >
      ...
      <div
        v-if="appInfo.desktop"
        ref="windowRefs"
        class="home-content wh100"
      ></div>
...
import vmControls from "./Controls.vue";
import vmCarConfig from "./CarConfig.vue";
// 模型选中发光 end -------
...
const addGf = () => {
  FBXloader.load(
    "https://blogs-macos.oss-cn-shenzhen.aliyuncs.com/threeJS/models/fbx/house/tree.fbx",
    function (object) {
    ...
    function (gltf) {
      ...
      if (isSuv) {
        ...
        let positionConfig = {
          ...
          wheel_backLeft: [-0.7, 0.5, 0.7],
          wheel_backRight: [0.7, 0.5, 0.7],
          wheel_frontLeft: [-0.7, 0.5, -0.7],
          wheel_frontRight: [0.7, 0.5, -0.7],
        };
        suvObj.traverse(function (child) {
          ...
          const [x, y, z] = positionConfig[name] || [
            child.position.x,
            child.position.y,
            child.position.z,
          ];
...
const addButler = () => {
  const configOgro = {
    ...
    // skins: [ "darkam.png"],
    skins: [
      "https://blogs-macos.oss-cn-shenzhen.aliyuncs.com/threeJS/models/md2/ogro/skins/darkam.png",
    ],
