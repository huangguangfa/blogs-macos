 ...
 * @param {*} Component
 */
export function createComponent(Component: DefineComponent, props: VNodeProps, children: _Vnode) {
    const vnode: _Vnode = h(Component, { ...props, ref: MOUNT_COMPONENT_REF }, children)
